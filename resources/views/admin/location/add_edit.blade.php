...
@section("content")
	<div class="row">
	    <div class="col-lg-12">
	        <h1 class="page-header">{{ trans('banner_messages.'.$action.'Location') }}</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<!-- /.row -->
	    ...
	    <div class="col-lg-12">
	        <div class="panel panel-default">
	            <div class="panel-heading">
	                <a href="{{ action('Admin\DashboardController@index') }}">{{ trans('banner_messages.home') }}</a> / <a href="{{ action('Admin\GroupuserController@index') }}">{{ trans('banner_messages.Location') }}</a> / {{ trans('banner_messages.'.$action.'Location') }}
	            </div>
	                    ...
	                    <div class="col-lg-6">
	                        <form role="form" id="formSubmit" action="{{ $actionLink }}" method="post">
	                            <div class="form-group">
	                                <label>{{ trans('banner_messages.locationName') }}</label>
	                                <input class="form-control" name="location_name" value="{{ inputValue('location_name', $data) }}">
	                            </div>
	                            <div class="form-group">
	                                <label>{{ trans('banner_messages.limit') }}</label>
